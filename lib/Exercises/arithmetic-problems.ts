...
const generateArithmeticProblems = (): Problem[] => {
    ...
    // 1. Basic Addition (ELO 100-200) -> Category: Arithmetic
    for (let i = 5; i <= 20; i++) {
        for (let j = 5; j <= 20; j++) {
            if (Math.random() > 0.3) continue;
            problems.push({
                id: `ARITH_ADD_${idCounter++}`,
                topic: "Addition", // Moved specific type to Topic
                category: "Arithmetic", // Matches UI Category
    ...
    // 2. Basic Subtraction (ELO 150-250) -> Category: Arithmetic
    for (let i = 10; i <= 30; i++) {
        for (let j = 5; j < i; j++) {
            if (Math.random() > 0.3) continue;
            problems.push({
    ...
    // 3. Multiplication (ELO 200-500) -> Category: Arithmetic
    for (let i = 2; i <= 12; i++) {
        for (let j = 2; j <= 12; j++) {
            problems.push({
    ...
    // 4. Division (ELO 350-650) -> Category: Arithmetic
    for (let i = 2; i <= 12; i++) {
        for (let j = 2; j <= 12; j++) {
            const product = i * j;
            problems.push({
    ...
    // 5. Basic Algebra (ELO 450-850)
    // Type: ax = b -> Category: Pre-Algebra (Matches PA02 in math-problems.ts)
    for (let a = 2; a <= 9; a++) {
        for (let x = 2; x <= 12; x++) {
            const b = a * x;
            problems.push({
    ...
    // Type: x + a = b -> Category: Pre-Algebra (Matches PA01)
    for (let a = 5; a <= 20; a++) {
        for (let x = 1; x <= 15; x++) {
            const b = x + a;
            problems.push({
    ...
    // Type: ax + b = c -> Category: Algebra I (Matches ALG01)
    for (let a = 2; a <= 6; a++) {
        for (let x = 2; x <= 10; x++) {
            for (let b = 1; b <= 10; b++) {
    ...
    // 6. Basic Exponents (ELO 650-950) -> Category: Arithmetic (Matches AR07)
    for (let base = 2; base <= 10; base++) {
        for (let exp = 2; exp <= 4; exp++) {
            problems.push({
                ...
                topic: "Exponents",
                category: "Arithmetic",
                difficulty: 650 + (Math.pow(base, exp) / 2),
