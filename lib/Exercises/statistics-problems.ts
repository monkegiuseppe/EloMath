...
export const statisticsProblems: Problem[] = [
    ...
    },
    {
        ...
        topic: "Permutations",
        difficulty: 1300,
        problem: "Compute $P(5, 2)$. (Permutation of 5 items taken 2 at a time).",
        answer: "20",
    },
    {
        category: "Combinatorics",
        ...
        topic: "Combinations",
        difficulty: 1350,
        problem: "Compute $C(6, 3)$ or $\\binom{6}{3}$.",
        answer: "20",
    },
    {
        ...
        topic: "Independent Events",
        difficulty: 1250,
        problem: "If $P(A) = 0.5$ and $P(B) = 0.4$ and events are independent, find $P(A \\cap B)$.",
        answer: "0.2",
    },
    {
        category: "Probability",
        ...
        topic: "Conditional Probability",
        difficulty: 1450,
        problem: "If $P(A \\cap B) = 0.1$ and $P(B) = 0.5$, find $P(A|B)$.",
        answer: "0.2",
    },
    {
        ...
        difficulty: 1600,
        problem: "Calculate the variance of the population set $\{2, 4, 6\}$.",
        answer: "2.67",
        format_hint: "Round to 2 decimal places."
    },
    {
        ...
        difficulty: 1700,
        problem: "For a binomial distribution with $n=3, p=0.5$, what is the probability of exactly 3 successes? (Decimal)",
        answer: "0.125",
    },
    {
        category: "Distributions",
        ...
        topic: "Normal Distribution",
        difficulty: 1750,
        problem: "In a standard normal distribution, what is the Z-score of the mean?",
        answer: "0",
    },
    {
        category: "Distributions",
        ...
        topic: "Expected Value",
        difficulty: 1650,
        problem: "A fair die is rolled. What is the expected value?",
        answer: "3.5",
    },
    {
        category: "Probability",
        ...
        topic: "Bayes Theorem",
        difficulty: 1900,
        problem: "If $P(B|A)=0.8$, $P(A)=0.1$, and $P(B)=0.2$, find $P(A|B)$.",
        answer: "0.4",
    },
    {
        category: "Combinatorics",
        ...
        difficulty: 1800,
        problem: "In how many ways can 5 people sit around a circular table? ($(n-1)!$)",
        answer: "24",
    }
];